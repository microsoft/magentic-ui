...
- web_search: Perform a web search query on DuckDuckGo.com
...
- tool_name: "web_search", tool_args: {{"query": str}} - Perform a web search on DuckDuckGo.com. The query arg is the search term to use.
...
Helpful tips to ensure success:
    ...
    - When filling a form, make sure to scroll down to ensure you fill the entire form.
    - Sometimes, searching DuckDuckGo for the method to do something in the general can be more helpful than searching for specific details.
