...
TRANSLATIONS = {
    "zh-CN": {
        "backend": {
            ...
            "magentic_ui_timed_out_waiting_for_input": "Spirits-灵七 在等待您的输入时超时。要恢复，请在输入框中输入后续消息，或者您可以简单地输入 'continue'。",
    ...
    "en-US": {
        "backend": {
            ...
            "magentic_ui_timed_out_waiting_for_input": "Spirits-灵七 timed out while waiting for your input. To resume, please enter a follow-up message in the input box or you can simply type 'continue'.",
