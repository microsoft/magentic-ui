...
def run_system_sim_user(args: Dict[str, Any], system_name: str) -> None:
    ...
    if system_name == "LLM":
        ...
        system = MagenticUIAutonomousSystem(
            ...
            dynamic_sentinel_sleep=args["enable_dynamic_sentinel_sleep"],
...
def main(
    ...
    enable_sentinel: Annotated[bool, typer.Option(help="🛡️ Enable sentinel tasks functionality in the orchestrator", rich_help_panel="🤖 System Configuration")] = False,
    enable_dynamic_sentinel_sleep: Annotated[bool, typer.Option(help="💤 Enable dynamic sleep duration adjustment for sentinel steps", rich_help_panel="🤖 System Configuration")] = False,
    ...
    args = {
        ...
        "enable_dynamic_sentinel_sleep": enable_dynamic_sentinel_sleep,
        "task_id": task_id,
        "base_task": base_task,
