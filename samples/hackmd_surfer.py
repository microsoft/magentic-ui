...
async def main() -> None:
    ...
    # Prompt for initial URL, default to HackMD.io
    initial_url = input("Enter initial URL to surf (default: https://hackmd.io): ")
    if not initial_url.strip():
        initial_url = "https://hackmd.io"
    ...
    web_surfer = WebSurfer(
        ...
        start_page=initial_url,
    )
    await web_surfer.lazy_init()

    # WebSurfer will start at the initial URL
