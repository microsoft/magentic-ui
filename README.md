...
<!-- Screenshots -->
<p align="center">
  <img src="img/magui-landing.png" alt="Magentic-UI Landing" width="45%" style="margin:10px;">
  <img src="img/magui-coplanning.png" alt="Co-Planning UI" width="45%" style="margin:10px;">
  <img src="img/magui-cotasking.png" alt="Co-Tasking UI" width="45%" style="margin:10px;">
  <img src="img/magui-actionguard.png" alt="Action Guard UI" width="45%" style="margin:10px;">
</p>
...
> **Note**: Before installing, please read the [pre-requisites](#prerequisites) carefully. Magentic-UI requires Docker to run, and if you are on Windows, you will need WSL2. We recommend using [uv](https://img.astral.sh/uv/getting-started/installation/) for a quicker installation. If you are using Mac or Linux, you can skip the WSL2 step.
...
<p align="center">
  <img src="./img/magenticui_running.png" alt="Magentic-UI" height="400">
</p>
...
<p align="center">
  <img src="./img/magenticui.jpg" alt="Magentic-UI" height="400">
</p>
