    ...
    <Collapse defaultActiveKey={["1"]} style={{ flex: 1, flexGrow: 1 }}>
      <Collapse.Panel
        ...
        header={
          <Flex align="center" justify="space-between" gap="small">
            <Tooltip title={nameError ? t("agentSettings.nameRequired") : ''} open={nameError ? undefined : false}>
              <Input
      ...
      >
        <Form layout="vertical">
          {advanced &&
            <>
              <Tooltip title={modelClientError ? t("agentSettings.modelError") : ''} open={modelClientError ? undefined : false}>
                <Form.Item
          ...
          <Tooltip title={descError ? t("agentSettings.descriptionRequired") : ''} open={descError ? undefined : false}>
            <Form.Item label={t("agentSettings.descriptionLabel")} required>
              <Input.TextArea
...
{/*           <Collapse>
          ...
          <Divider orientation="left" style={{ margin: "0px" }}>{t("agentSettings.mcpServersTitle")}</Divider>
          <Flex vertical gap="small">
            <Tooltip title={mcpServerError ? t("agentSettings.mcpServerRequired") : ''} open={mcpServerError ? undefined : false}>
              <List
                style={{
